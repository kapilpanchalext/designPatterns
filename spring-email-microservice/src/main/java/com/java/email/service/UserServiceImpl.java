...
//		emailService.sendHTMLEmailMessageWithAttachments(user.getName(), user.getEmail(), confirmation.getToken());

		emailService.sendHTMLEmailMessageWithEmbeddedFile(user.getName(), user.getEmail(), confirmation.getToken());
